...
import { ArrowsPointingOutIcon, BuildingOfficeIcon } from '@heroicons/react/24/outline'

export default function NotFound({ services }: { services: ServiceInterface[] }) {
  const links = [
    {
      name: 'All Services',
      href: '/services',
