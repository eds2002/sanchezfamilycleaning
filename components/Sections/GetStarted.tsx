      ...
      <div className="px-4 mx-auto max-w-7xl ">
        <div className="max-w-md">
          ...
          <p className="mt-2 text-slate-900/80">
            We&apos;re always looking for new clients, interested in our
            company? Request for a quote and we&apos;ll get back to you as soon
            as we can. Or you can study all of our services.
          </p>
